...
<head>
    <title>ELLITE COLORANTS AND ADDITIVES LLP</title>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="site-blocks-cover inner-page-cover overlay" style="background-image: url(images/CaCO3.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
            <div class="row align-items-center justify-content-center text-center">
                <div class="col-md-12" data-aos="fade-up" data-aos-delay="400">
                    <div class="row justify-content-center mb-4">
                        <div class="col-md-8 text-center">
                            <h1>Calcium Carbonate | CaCO3</h1>
                            <p class="lead mb-5">Calcium Carbonate (CaCO3) is one of the most popular mineral fillers used in the plastics, paint and rubber industries and is used in various applications from tyres, wire cable, flexible PVC, pipes, flooring, coatings, adhesives etc.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="site-section border-bottom">
        <div class="container">
            <div class="row mb-5 justify-content-center">
                <div class="col-md-8 text-center">
                    <p class="lead">Ellite Colorants markets the following range of coated calcium carbonate grades.</p>
                </div>
            </div>
            <div class="row">
    ...
    <section class="site-section border-bottom">
        <div class="container">
            <div class="row mb-5 justify-content-center">
                <div class="col-md-8 text-center">
                    <p class="lead">Ellite Colorants markets the following range of uncoated calcium carbonate grades.</p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up">
